...
export const projects = [
  ...
  {
    title: "Breast Cancer Lesion Detection",
    subtitle: "Deep Learning + Reinforcement Learning — Team Project",
    period: "2025",
    description:
      "Computer-vision pipeline on DICOM mammograms (INbreast) combining image preprocessing, a CBAM-attention CNN and a PPO curiosity-driven RL agent. The breast region is segmented with Otsu thresholding and morphology; 64×64 patches are classified with Focal Loss; the RL agent learns where to look, guided by tissue coverage. Evaluated with Precision, Recall, F1 and Specificity, and deployed as an HTTP API with Docker. My contribution: the RL + CNN core (data pipeline, CBAM CNN, PPO environment).",
    tags: ["Python", "PyTorch", "CNN", "CBAM", "Reinforcement Learning", "PPO", "Docker"],
    github: null,
    demo: null,
    featured: true,
  },
  {
    title: "MediNote",
    subtitle: "Multi-Agent Medical Report Platform — Team Project (ESPRIT)",
    period: "Feb — May 2026",
    description:
      "Intelligent platform to analyze and score medical visit reports (VITAL), built on a multi-agent architecture over a role-aware, JWT-secured data API. My contribution: the orchestrator agent (routing each query to the right agent), the data agent (querying structured business data) and the analysis agent (evaluating report quality and extracting key insights).",
    tags: ["Multi-Agent", "Orchestrator", "Data Agent", "NLP", "Python"],
    github: null,
    demo: null,
    featured: true,
  },
  ...
  {
    title: "Worker Productivity ML Platform",
    subtitle: "Multi-Model ML Deployment with Flask — Team Project",
    period: "2025",
    description:
      "Flask web application deploying a suite of machine-learning models around garment-worker productivity: regression (productivity gap, extra time), classification (overtime, task intensity) and clustering (team workload with K-Means & GMM, incentive segmentation). Each model is served through its own prediction page and JSON API endpoint, with shared preprocessing (scalers, label encoding).",
    tags: ["Python", "Flask", "scikit-learn", "LightGBM", "Clustering", "REST API"],
    github: null,
    demo: null,
    featured: false,
  },
